...
![The concision frontier: floor-pass vs drop-rate, one point per rule. The forceful-and-floor-safe top-right corner is empty.](assets/frontier.png)
...
![Force ladder: run-1 pooled drop-rate by rule, rising monotonically from R0 (63%) to R6 (97%) as the instruction gets more forceful.](assets/force_ladder.png)
...
![Floor-pass heatmap, rule by task. Every rule holds 100% except rank-only, which breaches on MP1 (13), MP2 (63), TEACH (50) and COLD (88).](assets/floor_heatmap.png)
